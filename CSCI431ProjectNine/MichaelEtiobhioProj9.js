...
var MIDDLE_ARM_HEIGHT = 3.0; //adding middle arm height
var MIDDLE_ARM_WIDTH = 0.5; //adding middle arm width
...
window.onload = function init() {
    ...
    document.getElementById("sliderM").onchange = function(event) {
...
var render = function() {
    ...
    modelViewMatrix = mult(modelViewMatrix, translate(-2.5, BASE_HEIGHT, 0.0)); 
